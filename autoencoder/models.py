"""
Code is copied from https://github.com/sccnlab/pub-CVAE-MRI-ASD/blob/main/Notebooks/make_models2.py
...
def get_MRI_CVAE_3D(input_shape=(64, 64, 64, 1), latent_dim=2, beta=1, disentangle=False, gamma=1, bias=True,
                    batch_size=64):
    image_size, _, _, channels = input_shape
    kernel_size = 3
    filters = 32
